...
docker run -d -e DISABLE_AUTH=true --rm -p 127.0.0.3:80:8787 -v C:/Users/andre/Dropbox/Dev/RStudioProjectTemplate:/home/rstudio/RStudioProjectTemplate rocker/verse:4.2.0
